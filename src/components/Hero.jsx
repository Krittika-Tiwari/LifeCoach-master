...
const Hero = () => {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center bg-gradient-to-br from-violet-50 via-purple-50 to-indigo-100 dark:from-gray-900 dark:via-purple-900/20 dark:to-indigo-900/20 pt-20"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 py-20">
          ...
          <div className="text-center lg:text-left space-y-8">
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start mb-6">
                <div className="text-xl sm:text-2xl font-bold text-primary font-lora text-center sm:text-left">
                  Sunita Life Coach
                </div>
              </div>
              ...
              <p className="text-lg sm:text-xl lg:text-2xl text-muted-foreground leading-relaxed text-center lg:text-left">
                Helping you break free from limits, heal emotionally, and create
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              >
                <Link
                  ...
                  to="https://docs.google.com/document/d/1ZsYybbG82CQ4nLgghrJam2T0ztwuXpCE9ySw4uvkerk/edit?tab=t.0#heading=h.ibkzz1yrv2kc"
                >
                  Download Free Guide
                </Link>
              </Button>
        ...
        <div className="mt-12 sm:mt-16 lg:mt-20 text-center">
          <h3 className="text-xl sm:text-2xl font-semibold text-foreground mb-6 sm:mb-8 px-4">
